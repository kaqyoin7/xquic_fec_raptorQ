#include "Helper.h"
// 提供参数分区、辅助计算、项目参数初始化等工具函数
// 包含分区结构体 PartitionS，以及组合数计算等静态工具
Helper::Helper()
{
}
...
void Helper::toString()
{
	...
	std::cout << "KL,KS,ZL,ZS" << std::endl
			  << KtZ.IL << "," << KtZ.IS << "," << KtZ.JL << "," << KtZ.JS << std::endl;
	std::cout << "TL,TS,NL,NS" << std::endl
			  << TAlN.IL << "," << TAlN.IS << "," << TAlN.JL << "," << TAlN.JS << std::endl;
}
